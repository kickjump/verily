...
void main() {
  group('DistanceSlider', () {
    testWidgets('renders slider with current value', (tester) async {
      await tester.pumpAppL10n(DistanceSlider(value: 10, onChanged: (_) {}));
