...
void main() {
  group('ActionCategoryService', () {
    ...
    group('create()', () {
      ...
      test('throws ValidationException when name already exists', () async {
    ...
    group('listAll()', () {
      test('returns categories ordered by sortOrder', () async {
        // await ActionCategoryService.create(
        //   session,
        //   name: 'Zeta',
        //   sortOrder: 2,
    ...
    group('findById()', () {
      test('returns category by primary key', () async {
    ...
    group('update()', () {
      ...
      test('updates description and iconName', () async {
        // final created = await ActionCategoryService.create(
        //   session,
        //   name: 'Update Fields',
        //   sortOrder: 0,
      ...
      test('allows updating with the same name (no change)', () async {
        // final created = await ActionCategoryService.create(
        //   session,
        //   name: 'Same Name',
        //   sortOrder: 0,
    ...
    group('ensureDefaults()', () {
      test('creates the four default categories', () async {
      ...
      test('default categories have correct sort order', () async {
        // await ActionCategoryService.ensureDefaults(session);
        //
      ...
      test('default categories have icons', () async {
        // await ActionCategoryService.ensureDefaults(session);
        //
        // final fitness = await ActionCategoryService.findByName(session, 'Fitness');
