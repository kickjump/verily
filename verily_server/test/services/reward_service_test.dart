...
void main() {
  ...
  final userId1 = UuidValue.fromString('11111111-2222-3333-4444-555555555555');
  final userId2 = UuidValue.fromString('22222222-3333-4444-5555-666666666666');
  ...
  group('RewardService', () {
    ...
    group('createReward()', () {
      test(
        'creates a reward linked to an action',
        () async {
      ...
      test(
        'creates a reward with minimal fields',
        () async {
          // final reward = await RewardService.createReward(
          //   session,
          //   rewardType: 'points',
    ...
    group('findRewardsByAction()', () {
      test(
        'returns all rewards for an action',
        () async {
      ...
      test(
        'returns empty list for action with no rewards',
        () async {
          // final rewards = await RewardService.findRewardsByAction(
          //   session,
          //   actionId: testAction.id!,
    ...
    group('grantReward()', () {
      ...
      test(
        'is idempotent for same reward+submission combination',
        () async {
          // final reward = await RewardService.createReward(
          //   session,
          //   rewardType: 'badge',
      ...
      test(
        'allows duplicate grants without submissionId',
        () async {
          // final reward = await RewardService.createReward(
          //   session,
          //   rewardType: 'badge',
    ...
    group('grantActionRewards()', () {
      test(
        'grants all rewards for an action to a user',
        () async {
          // await RewardService.createReward(
          //   session,
          //   rewardType: 'badge',
      ...
      test(
        'returns empty list when action has no rewards',
        () async {
          // final grants = await RewardService.grantActionRewards(
          //   session,
          //   userId: userId1,
    ...
    group('findUserRewards()', () {
      test(
        'returns all rewards earned by a user',
        () async {
          // final reward = await RewardService.createReward(
          //   session,
          //   rewardType: 'badge',
    ...
    group('hasReward()', () {
      test(
        'returns true when user has the reward',
        () async {
          // final reward = await RewardService.createReward(
          //   session,
          //   rewardType: 'badge',
      ...
      test(
        'returns false when user does not have the reward',
        () async {
          // final has = await RewardService.hasReward(
          //   session,
          //   userId: userId1,
    ...
    group('getLeaderboard()', () {
      test(
        'returns entries sorted by total points descending',
        () async {
      ...
      test(
        'includes correct reward counts',
        () async {
          // final reward = await RewardService.createReward(
          //   session,
          //   rewardType: 'badge',
    ...
    group('getUserStats()', () {
      test(
        'returns stats for a user with rewards',
        () async {
          // final reward = await RewardService.createReward(
          //   session,
          //   rewardType: 'badge',
      ...
      test(
        'returns null for user with no rewards',
        () async {
          // final stats = await RewardService.getUserStats(
          //   session,
          //   userId: userId1,
