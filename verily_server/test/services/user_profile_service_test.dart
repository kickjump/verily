...
void main() {
  ...
  group('Username from email extraction (pure logic)', () {
    ...
    test('strips dots and hyphens', () {
      expect(
        usernameFromEmail('john.doe@example.com'),
        equals('johndoe'),
      );
      expect(
        usernameFromEmail('jane-smith@example.com'),
        equals('janesmith'),
      );
    });
    ...
    test('preserves underscores', () {
      expect(
        usernameFromEmail('user_name@example.com'),
        equals('user_name'),
      );
    });
    ...
    test('strips plus addressing', () {
      expect(
        usernameFromEmail('user+tag@example.com'),
        equals('usertag'),
      );
    });
    ...
    test('handles email with multiple dots', () {
      expect(
        usernameFromEmail('a.b.c.d@example.com'),
        equals('abcd'),
      );
    });
  });
  ...
  group('UserProfileService (database operations)', () {
    ...
    group('getOrCreate()', () {
      ...
      test('returns existing profile on subsequent calls', () async {
      ...
      test('generates a random username when email is null', () async {
        // final profile = await UserProfileService.getOrCreate(
        //   session,
        //   authUserId: testAuthUserId,
        // );
      ...
      test('appends suffix when username is taken', () async {
    ...
    group('findById()', () {
      test('returns profile by primary key', () async {
    ...
    group('findByUsername()', () {
      test('returns profile for existing username', () async {
        // await UserProfileService.getOrCreate(
        //   session,
        //   authUserId: testAuthUserId,
        //   email: 'alice@example.com',
    ...
    group('update()', () {
      ...
      test('updates username with validation', () async {
        // await UserProfileService.getOrCreate(
        //   session,
        //   authUserId: testAuthUserId,
        //   email: 'alice@example.com',
      ...
      test('throws ValidationException for too-short username', () async {
        // await UserProfileService.getOrCreate(
        //   session,
        //   authUserId: testAuthUserId,
        // );
      ...
      test('throws ValidationException for username with special chars',
          () async {
        // await UserProfileService.getOrCreate(
        //   session,
        //   authUserId: testAuthUserId,
      ...
      test('throws ValidationException for taken username', () async {
        // // Create two profiles.
        // await UserProfileService.getOrCreate(
        //   session,
        //   authUserId: testAuthUserId,
      ...
      test('throws NotFoundException for non-existent profile', () async {
        // expect(
        //   () => UserProfileService.update(
        //     session,
      ...
      test('updates bio, avatarUrl, isPublic, and socialLinks', () async {
        // await UserProfileService.getOrCreate(
        //   session,
        //   authUserId: testAuthUserId,
        // );
    ...
    group('search()', () {
      test('finds public profiles by username', () async {
        // await UserProfileService.getOrCreate(
        //   session,
        //   authUserId: testAuthUserId,
        //   email: 'alice@example.com',
      ...
      test('does not return private profiles', () async {
        // await UserProfileService.getOrCreate(
        //   session,
        //   authUserId: testAuthUserId,
        //   email: 'alice@example.com',
    ...
    group('count()', () {
      test('returns total profile count', () async {
