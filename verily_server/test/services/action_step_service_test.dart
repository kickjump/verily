...
void main() {
  ...
  group('ActionStepService', () {
    ...
    group('create()', () {
      test('creates a step for a sequential action', () async {
      ...
      test('creates a step with optional description', () async {
        // final step = await ActionStepService.create(
        //   session,
        //   actionId: sequentialAction.id!,
        //   stepNumber: 2,
      ...
      test('throws ValidationException for non-sequential action', () async {
        // expect(
        //   () => ActionStepService.create(
        //     session,
      ...
      test('throws ValidationException when stepNumber is less than 1',
          () async {
        // expect(
        //   () => ActionStepService.create(
        //     session,
      ...
      test('throws ValidationException when stepNumber is negative', () async {
        // expect(
        //   () => ActionStepService.create(
        //     session,
        //     actionId: sequentialAction.id!,
    ...
    group('createBatch()', () {
      test('creates multiple steps in a single batch', () async {
        // final steps = [
        //   ActionStep(
        //     actionId: sequentialAction.id!,
        //     stepNumber: 1,
    ...
    group('findByActionId()', () {
      test('returns steps ordered by step number', () async {
      ...
      test('returns empty list for action with no steps', () async {
        // final steps = await ActionStepService.findByActionId(
        //   session,
        //   actionId: sequentialAction.id!,
        // );
    ...
    group('findByActionAndStep()', () {
      test('returns the correct step', () async {
        // await ActionStepService.create(
        //   session,
        //   actionId: sequentialAction.id!,
        //   stepNumber: 1,
      ...
      test('throws NotFoundException for non-existent step number', () async {
        // expect(
    ...
    group('findById()', () {
      test('returns step by primary key', () async {
    ...
    group('update()', () {
      ...
      test('updates step verificationCriteria', () async {
        // final created = await ActionStepService.create(
        //   session,
        //   actionId: sequentialAction.id!,
        //   stepNumber: 1,
    ...
    group('deleteAllForAction()', () {
      test('removes all steps for an action', () async {
        // for (var i = 1; i <= 3; i++) {
        //   await ActionStepService.create(
        //     session,
        //     actionId: sequentialAction.id!,
      ...
      test('is a no-op if action has no steps', () async {
        // Expect no exception.
        // await ActionStepService.deleteAllForAction(
        //   session,
        //   actionId: sequentialAction.id!,
    ...
    group('countForAction()', () {
      test('returns correct count of steps', () async {
        // for (var i = 1; i <= 3; i++) {
        //   await ActionStepService.create(
        //     session,
        //     actionId: sequentialAction.id!,
      ...
      test('returns 0 for action with no steps', () async {
        // final count = await ActionStepService.countForAction(
        //   session,
        //   actionId: sequentialAction.id!,
        // );
