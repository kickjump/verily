...
void main() {
  ...
  group('ActionService', () {
    ...
    group('create()', () {
      test('creates a one-off action with required fields', () async {
      ...
      test('creates a sequential action with totalSteps', () async {
        // final action = await ActionService.create(
        //   session,
      ...
      test('throws ArgumentError for invalid action type', () async {
        // expect(
        //   () => ActionService.create(
        //     session,
        //     title: 'Invalid Type',
      ...
      test('creates action with optional fields', () async {
        // final action = await ActionService.create(
        //   session,
        //   title: 'Full Action',
      ...
      test('sets createdAt and updatedAt to current UTC time', () async {
    ...
    group('findById()', () {
      test('returns an existing action', () async {
    ...
    group('list()', () {
      test('returns actions with default pagination', () async {
    ...
    group('search()', () {
      test('finds actions by title substring', () async {
        // await ActionService.create(
        //   session,
      ...
      test('finds actions by description substring', () async {
        // await ActionService.create(
        //   session,
        //   title: 'Something',
    ...
    group('update()', () {
      test('updates title when called by owner', () async {
        // final created = await ActionService.create(
        //   session,
      ...
      test('throws ForbiddenException when non-owner tries to update',
          () async {
        // final created = await ActionService.create(
        //   session,
        //   title: 'Owner Only',
    ...
    group('archive()', () {
      ...
      test('throws ForbiddenException when non-owner tries to archive',
          () async {
        // final created = await ActionService.create(
        //   session,
        //   title: 'No Archive',
    ...
    group('delete()', () {
      test('deletes an action by owner', () async {
        // final created = await ActionService.create(
        //   session,
        //   title: 'Delete Me',
        //   description: 'desc',
      ...
      test('throws ForbiddenException when non-owner tries to delete',
          () async {
        // final created = await ActionService.create(
        //   session,
        //   title: 'Cant Delete',
    ...
    group('countActive()', () {
      test('returns count of active actions', () async {
        // final count = await ActionService.countActive(session);
        // expect(count, isA<int>());
        // expect(count, greaterThanOrEqualTo(0));
      }, skip: 'Requires serverpod_test database session');

      test('does not count archived actions', () async {
        // final created = await ActionService.create(
        //   session,
        //   title: 'Will Archive',
        //   description: 'desc',
    ...
    group('findByCreator()', () {
      test('returns only actions by the specified creator', () async {
        // await ActionService.create(
        //   session,
        //   title: 'By Creator',
        //   description: 'desc',
