...
void main() {
  group('VerificationService', () {
    ...
    group('createFromGeminiResponse()', () {
      test('passes when confidence >= 0.7 and no spoofing', () async {
      ...
      test('fails when confidence < 0.7', () async {
        // final result = await VerificationService.createFromGeminiResponse(
        //   session,
        //   submissionId: testSubmission.id!,
      ...
      test('fails when spoofing detected even with high confidence', () async {
        // final result = await VerificationService.createFromGeminiResponse(
        //   session,
        //   submissionId: testSubmission.id!,
      ...
      test('passes at exactly 0.7 threshold with no spoofing', () async {
        // final result = await VerificationService.createFromGeminiResponse(
        //   session,
        //   submissionId: testSubmission.id!,
      ...
      test('fails at 0.699 confidence', () async {
        // final result = await VerificationService.createFromGeminiResponse(
        //   session,
        //   submissionId: testSubmission.id!,
