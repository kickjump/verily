...
void main() {
  ...
  group('SeedService constants (pure logic)', () {
    test('systemCreatorId is the well-known zero UUID', () {
      ...
      expect(systemId.toString(), equals('00000000-0000-0000-0000-000000000000'));
    });
  });
  ...
  group('SeedService (database operations)', () {
    ...
    group('seedAll()', () {
      ...
      test('creates "Star Jump Champion" action', () async {
        // await SeedService.seedAll(session);
        //
        // final actions = await ActionService.search(
        //   session,
      ...
      test('creates rewards for each seed action', () async {
        // await SeedService.seedAll(session);
        //
    ...
    group('idempotency', () {
      ...
      test('calling seedAll twice does not create duplicate categories',
          () async {
        // await SeedService.seedAll(session);
    ...
    group('seed data content', () {
      test('press-up challenge steps have increasing rep counts', () async {
        // await SeedService.seedAll(session);
        //
        // final challenge = (await ActionService.search(
        //   session,
      ...
      test('seed actions have proper verification criteria', () async {
        // await SeedService.seedAll(session);
        //
        // final pressups = (await ActionService.search(
        //   session,
      ...
      test('seed actions are assigned to correct categories', () async {
        // await SeedService.seedAll(session);
        //
